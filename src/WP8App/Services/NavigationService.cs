...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.INDTVGadgets_NewsViewModel), "/View/NDTVGadgets_News.xaml" },
            { typeof(IViewModels.IVideos_DetailVideosViewModel), "/View/Videos_DetailVideos.xaml" },
            { typeof(IViewModels.ICnetNEWS_DetailViewModel), "/View/CnetNEWS_Detail.xaml" },
            { typeof(IViewModels.IGeekyGadgets_DetailViewModel), "/View/GeekyGadgets_Detail.xaml" },
            { typeof(IViewModels.ICNET_DetailViewModel), "/View/CNET_Detail.xaml" },
            { typeof(IViewModels.INDTVGadgets_DetailViewModel), "/View/NDTVGadgets_Detail.xaml" },
