...
{
    /// <summary>
    /// Phone application page for CnetNEWS_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class CnetNEWS_Detail : PhoneApplicationPage
    {       
        /// <summary>
        ...
        private void panoramaCnetNEWS_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaCnetNEWS_Detail(PanoramaCnetNEWS_Detail.SelectedItem as PanoramaItem);
        }
