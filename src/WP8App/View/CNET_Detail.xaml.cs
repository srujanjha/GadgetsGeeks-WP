...
{
    /// <summary>
    /// Phone application page for CNET_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class CNET_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for CNET_Detail and all its components.
        /// </summary>
        public CNET_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaCNET_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaCNET_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaCNET_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaCNET_Detail(PanoramaCNET_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaCNET_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.ICNET_s2>();
				AddHomeAppBarButton();
				...
				((IViewModels.ICNET_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
