...
{
    /// <summary>
    /// Phone application page for NDTVGadgets_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class NDTVGadgets_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for NDTVGadgets_Detail and all its components.
        /// </summary>
        public NDTVGadgets_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaNDTVGadgets_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaNDTVGadgets_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaNDTVGadgets_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaNDTVGadgets_Detail(PanoramaNDTVGadgets_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaNDTVGadgets_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.INDTVGadgets_s1>();
				AddHomeAppBarButton();
				...
				((IViewModels.INDTVGadgets_DetailViewModel)DataContext).CurrentRssSearchResult = pinnedItem;				
			}
		}
