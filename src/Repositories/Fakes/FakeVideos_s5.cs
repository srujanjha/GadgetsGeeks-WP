...
{
    /// <summary>
    /// Fake s5_YouTubeVideo data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeVideos_s5 : IVideos_s5 
    {
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of s5_YouTubeVideo items.
        /// </summary>
