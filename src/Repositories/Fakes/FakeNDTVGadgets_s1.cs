...
{
    /// <summary>
    /// Fake s1_RssSearchResult data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeNDTVGadgets_s1 : INDTVGadgets_s1 
    {
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of s1_RssSearchResult items.
        /// </summary>
