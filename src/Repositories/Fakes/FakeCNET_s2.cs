...
{
    /// <summary>
    /// Fake s2_RssSearchResult data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeCNET_s2 : ICNET_s2 
    {
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of s2_RssSearchResult items.
        /// </summary>
