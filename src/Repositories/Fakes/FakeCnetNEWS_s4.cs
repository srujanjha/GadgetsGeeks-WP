...
{
    /// <summary>
    /// Fake s4_RssSearchResult data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeCnetNEWS_s4 : ICnetNEWS_s4 
    {
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of s4_RssSearchResult items.
        /// </summary>
