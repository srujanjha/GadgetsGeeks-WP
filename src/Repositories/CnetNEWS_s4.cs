...
namespace WPAppStudio.Repositories
{
    ...
    public class CnetNEWS_s4 : ICnetNEWS_s4 
    {
		...
		private const string RssUrl = "http://feeds.feedburner.com/cnet/tcoc";

        /// <summary>
        /// Initializes a new instance of the <see cref="CnetNEWS_s4" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public CnetNEWS_s4(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://feeds.feedburner.com/cnet/tcoc), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("CnetNEWS_s4", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("CnetNEWS_s4");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://feeds.feedburner.com/cnet/tcoc), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
