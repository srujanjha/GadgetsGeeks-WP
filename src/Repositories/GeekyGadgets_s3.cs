...
namespace WPAppStudio.Repositories
{
    ...
    public class GeekyGadgets_s3 : IGeekyGadgets_s3 
    {
		...
		private const string RssUrl = "http://feeds.feedburner.com/geeky-gadgets";

        /// <summary>
        /// Initializes a new instance of the <see cref="GeekyGadgets_s3" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public GeekyGadgets_s3(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://feeds.feedburner.com/geeky-gadgets), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("GeekyGadgets_s3", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("GeekyGadgets_s3");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://feeds.feedburner.com/geeky-gadgets), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
