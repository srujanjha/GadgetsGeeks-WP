...
namespace WPAppStudio.Repositories
{
    ...
    public class CNET_s2 : ICNET_s2 
    {
		...
		private const string RssUrl = "http://reviews.cnet.com/4951-5_7.xml?vn=25";

        /// <summary>
        /// Initializes a new instance of the <see cref="CNET_s2" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public CNET_s2(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://reviews.cnet.com/4951-5_7.xml?vn=25), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("CNET_s2", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("CNET_s2");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://reviews.cnet.com/4951-5_7.xml?vn=25), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
