...
namespace WPAppStudio.Repositories
{
    ...
    public class NDTVGadgets_s1 : INDTVGadgets_s1 
    {
		...
		private const string RssUrl = "http://gadgets.ndtv.com/rss/news";

        /// <summary>
        /// Initializes a new instance of the <see cref="NDTVGadgets_s1" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public NDTVGadgets_s1(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://gadgets.ndtv.com/rss/news), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("NDTVGadgets_s1", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("NDTVGadgets_s1");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://gadgets.ndtv.com/rss/news), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
