...
namespace WPAppStudio.Repositories
{
    ...
    public class Videos_s5 : IVideos_s5 
    {
		...
		private const string YoutubeQuery = @"CNETTV";
		private const string YoutubePaginationParameters = "&start-index={1}&max-results={2}";

        /// <summary>
        /// Initializes a new instance of the <see cref="Videos_s5" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Videos_s5(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: CNETTV ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: CNETTV ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
